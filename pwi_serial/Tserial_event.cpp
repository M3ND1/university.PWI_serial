...
void Tserial_event::OnEvent (unsigned long events)
{
    ...
    if ((events & EV_RING)!=0)
    {
        ...
        {
            if (manager!=0)
                manager(this, SERIAL_RING);    // BYLO: manager((uint32) this, SERIAL_RING);
        }
    }
    ...
    if ((events & EV_RLSD)!=0)
    {
        ...
        {
            if (manager!=0)
                manager(this, SERIAL_CD_ON);   // BYLO: manager((uint32) this, SERIAL_CD_ON);
        }
        else
        {
            if (manager!=0)
                manager(this, SERIAL_CD_OFF);  // BYLO: manager((uint32) this, SERIAL_CD_OFF);
        }
    }
}
/* -------------------------------------------------------------------- */
...
void Tserial_event::run(void)
{
    ...
    if (manager!=0)
        manager(this, SERIAL_CONNECTED);   // BYLO: manager((uint32) this, SERIAL_CONNECTED);
            ...
            switch(status)
            {
                ...
                case SIG_READER:
                        ...
                        &result_nbr, FALSE))
                    {
                        ...
                        if ((result_nbr!=0) &&(manager!=0))
                            manager(this, SERIAL_DATA_ARRIVAL);    // BYLO: manager((uint32) this, SERIAL_DATA_ARRIVAL);
                ...
                case SIG_WRITER:
                        ...
                        &result_nbr, FALSE))
                    {
                        ...
                        if (manager!=0)
                            manager(this, SERIAL_DATA_SENT);   // BYLO: manager((uint32) this, SERIAL_DATA_SENT);
                    }
                    else
                    {
                        // GetOverlapped didn't succeed !
    ...
    if (manager!=0)
        manager(this, SERIAL_DISCONNECTED);    // BYLO: manager((uint32) this, SERIAL_DISCONNECTED);
}
/* -------------------------------------------------------------------- */
/* -------------------------------------------------------------------- */
